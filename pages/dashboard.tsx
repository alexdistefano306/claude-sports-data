            ...
            <section style={panelStyle}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(230px, 1fr))', gap: 10 }}>
                {filteredPlayers.slice(0, 36).map((player) => {
                  ...
                  return (
                    <div key={player.slug} style={{ ...panelStyle, padding: 10 }}>
                      ...
                      <button
                        ...
                        style={{ marginTop: 8, borderRadius: 8, border: '1px solid #2563eb', background: isSelected ? '#dbeafe' : '#eff6ff', padding: '6px 10px', cursor: isSelected ? 'default' : 'pointer' }}
                      >
